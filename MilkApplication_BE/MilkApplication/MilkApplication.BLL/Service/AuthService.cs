...
namespace MilkApplication.BLL.Service
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(IAuthRepository authRepository, RoleManager<IdentityRole> roleManager, ILogger<AuthService> logger, UserManager<ApplicationUser> userManager)
        {
        ...
        public async Task<ResponseDTO> RegisterUserAsync(ApplicationUser user, string password, UserRole role)
        {
            ...
            if (!createUserResult.Succeeded)
            {
                ...
                return new ResponseDTO { IsSucceed = false, Message = "Failed to create user" };
            }
            ...
            if (!await _roleManager.RoleExistsAsync(roleName))
            {
                ...
                if (!createRoleResult.Succeeded)
                {
                    ...
                    return new ResponseDTO { IsSucceed = false, Message = "Failed to create role" };
                }
            }
            ...
            if (!addToRoleResult.Succeeded)
            {
                ...
                return new ResponseDTO { IsSucceed = false, Message = "Failed to add user to role" };
            }
